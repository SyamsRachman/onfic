...
<?php $__env->startSection('main'); ?>
  <script type="text/javascript">
    function isiSpesies1(){
      ...
      // $("#sIkan1").html('<?php $__currentLoopData = App\SpesiesIkan::where('id_ikan',1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tabelSpesies): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
